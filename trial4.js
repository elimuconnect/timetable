...
function calculateCandidateSlotScore(
    ...
    // --------------------------------------------------------
    // Prefer spreading the subject across different days.
    // --------------------------------------------------------
    ...
    if (
        ...
        reasons.push(
            "Earlier teaching period is mildly preferred."
        );
...
// ========================================================
// STAGE 6F.5 — REPAIR REMAINING FAILED LESSONS
// ========================================================
//
// The normal greedy generator above is intentionally left
// unchanged.
//
// Any lessons that could not be placed are now passed to a
// separate repair function.
//
// The repair function will attempt to use:
//
//     1. Direct free slots
//     2. Local movement of existing lessons
//     3. Re-checking the displaced lesson
//
// It will NOT alter the original generation algorithm.
//
// ========================================================
...
if (
    ...
    console.log(
        "STAGE 6F.5 — REPAIRING REMAINING LESSONS"
    );
    ...
    if (
        typeof repairRemainingTimetableLessons ===
        "function"
    ) {

        repairRemainingTimetableLessons(
            result,
            data,
            indexes
        );
        ...
        console.warn(
            "STAGE 6F.5 — Repair function not yet loaded."
        );

...
// ============================================================
//
// Identifies WHICH occurrence of a parallel lesson this is.
//
// Example:
//
// parallelGroup = "FORM1_MATH_PARALLEL"
// occurrenceKey = "1"
//
// Different occurrences in the same parallel group must NOT
// be treated as the same synchronized lesson.
//
// ============================================================
...
//     parallelOccurrenceKey
//
// into one deterministic identity.
//
// ============================================================
...
function getTaskParallelIdentity(task) {
    ...
    if (!group || !occurrenceKey) {
        return "";
    }

    return `${group}__${occurrenceKey}`;

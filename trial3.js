...
// IMPORTANT:
//
// A parallel group is NOT a property of one stream only.
//
// It is a school-wide synchronization group.
//
// Example:
//
//     RE/GE/BS
...
//     10E
//
// This function records all participating streams and
// requirements.
//
// Later placement code can therefore require ONE common
// period for the complete participating set.
//
// ============================================================
...
function normalizeGeneratorData(
    ...
    //
    // Every requirement belonging to the same parallel_group
    // is collected across ALL streams.
    //
    // Later placement logic can therefore synchronize:
    //
    //     stream A
    //     stream B
    //     stream C
    //
    // at exactly the same day + period.
    //
    // ========================================================
    ...
    // IMPORTANT:
    //
    // Rooms are now normalized BEFORE lookup maps are built.
    //
    // ========================================================
...
function validateGeneratorRelationships(data) {
    ...
    // ========================================================
    //
    // Every requirement belonging to the same parallel group
    // must participate in the same school-wide synchronization
    // pool.
    //
    // We do NOT reject different lesson counts here.
    //
    // Instead we report them as warnings because the actual
    // scheduling engine may still be able to handle the
    // difference depending on the configured requirements.
    //
    // ========================================================
            ...
            group => {
                ...
                if (
                    ...
                    warnings.push({
                        ...
                        message:
                            "Parallel group currently contains fewer than two streams."
                ...
                if (
                    ...
                    warnings.push({
                        ...
                        message:
                            "Requirements in this parallel group have different lessons-per-week totals. Matching occurrences will be synchronized, while unmatched occurrences may remain unsynchronized."
